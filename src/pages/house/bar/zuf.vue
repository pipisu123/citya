				...
				<view class="u-demo-area">
					<u-grid :col="col" @click="click" v-if="!isSwiper" :border="border">
						<u-grid-item name="item1" :index="0" @click="itemClick">
							...
							<view class="grid-text">二手房</view>
						</u-grid-item>
						<u-grid-item :index="1">
							<u-icon name="lock" :size="46"></u-icon>
							<view class="grid-text">新盘</view>
						</u-grid-item>
						<u-grid-item :index="2">
							...
							<view class="grid-text">租房</view>
						</u-grid-item>
						<u-grid-item :index="3">
							<u-icon name="home" :size="46"></u-icon>
							<view class="grid-text">出售</view>
						</u-grid-item>
						<u-grid-item :index="4">
							<u-icon name="star" :size="46"></u-icon>
							<view class="grid-text">找小区</view>
						</u-grid-item>
						<u-grid-item :index="5">
							<u-icon name="volume-up" :size="46"></u-icon>
							<view class="grid-text">写字楼</view>
						</u-grid-item>
						<u-grid-item :index="6">
							...
							<view class="grid-text">仓库商铺</view>
						</u-grid-item>
						<u-grid-item :index="7">
							<u-icon name="rewind-right" :size="46"></u-icon>
							<view class="grid-text">我是业主</view>
						</u-grid-item>
						<u-grid-item :index="8">
							<u-icon name="shopping-cart" :size="46"></u-icon>
							<view class="grid-text">中介</view>
						</u-grid-item>
					</u-grid>
