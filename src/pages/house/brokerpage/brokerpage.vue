	...
	<view>
	    <u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType">
	    	<u-form-item>
	    		...
	    		<u-form-item :leftIconStyle="{color: '#888', fontSize: '16rpx'}" label-width="130" :label-position="labelPosition" label="姓名" prop="welfare">
	    			<u-input :border="border" placeholder="请输入真实姓名" v-model="model.welfare" type="text"></u-input>
	    		</u-form-item>
	    ...
	    <u-button @click="create" type="primary">已完善</u-button>
	</view>
</template>
