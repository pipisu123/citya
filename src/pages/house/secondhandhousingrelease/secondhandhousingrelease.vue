...
<view class="content">
	<!-- 创建房源信息-->
		<u-form :model="model" :rules="rules" ref="uForm" :errorType="errorType" v-if="showview">
			...
			<u-form-item :label-position="labelPosition" label="出售类型" prop="zuf" label-width="150" color="#a0cfff">
				<u-input :border="border" type="select" :select-open="selectShow5" v-model="model.zuf" placeholder="请选择出售类型" @click="selectShow5 = true"></u-input>
			</u-form-item>
...
<!-- 			<u-form-item :label-position="labelPosition" label="上传视频" prop="vieo" label-width="150">
				<u-upload width="160" height="160" action="#"  ref="uUpload" :auto-upload="false" :before-upload="beforeUpload" max-count=1 :max-size="1 * 1024 * 1024" ></u-upload>
			</u-form-item> -->
